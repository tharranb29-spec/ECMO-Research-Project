...
def main() -> None:
    ...
    payload = {
        ...
        "workstreams": {
            ...
            "D_dashboard": {
                "status": "static_v1_contract_dashboard_implemented",
                "current_mode": "legacy_dashboard_preserved_track3_dashboard_read_only",
                ...
                "autonomous_mode": "shadow_only",
                "served_track3_model": None,
                "next_gate": "connect additive literature updates as shadow proposals only after contract validation; retain external, human-release, and Tier B promotion gates",
            },
        },
        "artifact_hashes": {
