...
The first two full v1.6.4 equilibration replicas, 5NM4-ZMA seeds 20260914 and 20260915, subsequently completed all 2.14 ns and passed. Final temperatures were `309.0 K` and `309.75 K`, native-contact fractions were `0.8533` and `0.8933`, last-half volume CVs were `0.00170` and `0.00172`, and all monitored energy, temperature, and volume values were finite. They count as two of six required equilibration replicas; production and Tier B remain locked pending the complete aggregate gate.
