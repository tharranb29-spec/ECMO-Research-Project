...
The first full v1.6.4 equilibration replica, 5NM4-ZMA seed 20260914, subsequently completed all 2.14 ns and passed. Final temperature was `309.0 K`, native-contact fraction was `0.8533`, last-half volume CV was `0.00170`, and all monitored energy, temperature, and volume values were finite. It counts as one of six required equilibration replicas; production and Tier B remain locked pending the complete aggregate gate.
